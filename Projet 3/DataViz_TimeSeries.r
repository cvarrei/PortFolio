...
year_price$High <- round(year_price$High,0)
 ...
 yearly= ggplot(year_price, aes(x=year, y=High))+ #Creation of the bar plot 
     ...
     geom_text(aes(label = High), vjust = 1.5, colour = "white", fontface = "bold", size = 6)+
     labs(
 ...
 png(file = "Dashboard.png", width = 3000, height = 2000, res = 300) #We save the dashboard in tiff.format.
 dash
 dev.off()